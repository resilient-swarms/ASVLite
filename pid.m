%PID controller for a quad-propeller ASV with the following configuration
% Useful references: 
...
op_throttle = 0; % range [0, Fmax]  % where Fmax is the maximum force that can be generated by the propellers (unit in Newtons) 
