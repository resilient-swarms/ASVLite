...
int main() {
    ...
    std::cout << "Simulation completed in " << duration.count()/1000'000.0 << " seconds." << std::endl;
    std::cout << "Simulation speed " << simulation_duration/duration.count()*1000'000.0 << " X realtime speed." << std::endl;
